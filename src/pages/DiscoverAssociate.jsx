...
import AssociateCard from "../components/AssociateCard.jsx";

const DiscoverAssociate = () => {
  const services = [
    {
      title: "CRIMINAL",
    },
    ...
    {
      title: "Bhagalpur Civil Court All Work",
    },
    {
      title: "Miscellaneous (विविध)",
    },
    {
...
export default DiscoverAssociate;
